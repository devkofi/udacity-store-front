...
var orderProducts = new orderProducts_1.OrderProducts();
var order = new order_1.Order();
var product = new product_1.Product();
var user = new user_1.User();
describe("ORDER PRODUCTS TEST: ", function () {
    describe("Test Suite for OrderProducts Methods: ", function () {
    ...
    describe("Test Suite for Order Length of Array: ", function () {
                                    ...
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, user
                                                ...
                                                var result = function () { return __awaiter(void 0, void 0, void 0, function () {
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            case 0: return [4 /*yield*/, orderProducts.create({
                                                                    order_id: 1,
                                                                    product_id: 1,
                                                                    quantity: 4
                                                                })];
        ...
        it("index returns an array of orders", function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderProducts.index().then(function (item) {
        ...
        it("show method should return the correct order", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderProducts.show("1")];
                    case 1:
                        result = _a.sent();
                        expect(result.length).toBeGreaterThanOrEqual(0);
                        return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, orderProducts.index()];
                    case 1:
                        result = _a.sent();
                        expect(result.length).toBeGreaterThanOrEqual(0);
                        return [2 /*return*/];
